...
{
public:
    void Solve(int Current_Row, int Queens, int N_RS_CLS, vector<string> Board, int &Res, unordered_set<int> &Used_Rows, unordered_set<int> &Used_Cols, unordered_set<int> &Used_Di, unordered_set<int> &Used_AntiDi)
    {
        if (Queens == 0)
        {
            Res++;
